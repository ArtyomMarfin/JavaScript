...
console.log(users.filter(el => el.registrationDate == '10.10.2021'), users.filter(el => el.registrationDate == '09.10.2021'))
...
function uniqueValue = (i) {
    const unique = Array.from(new Set(i));
